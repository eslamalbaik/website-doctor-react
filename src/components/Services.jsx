    ...
    <div className='lg:h-[990px]  h-auto pt-[200px] bg-[#F6FDFF]'>
      ...
      <div>
        <div className=' flex lg:flex-row lg:mx-40 flex-col gap-10 mb-14 '>
          <div className='bg-white w-full rounded-[44px] my-1 space-y-4 pb-8 md:w-1/2 lg:my-4 flex justify-center items-center flex-col shadow-sm shadow-transparent hover:shadow-[#04C873]' >
            <div className='  border-transparent  hover:border-[#02c873]  '>
              <img className='w-[365px] h-[280px] rounded-tr-[44px]  rounded-bl-[280px]' src={img1} alt="ico_1" />
            </div>
